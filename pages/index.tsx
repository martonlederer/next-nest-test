      ...
      <main>
        ...
        <div className="section">
          ...
          <p className="description">
            ...
            . With us, you can publish your Deno modules to the permaweb, where they can never be deleted.
          ...
          <div className={styles.faq}>
            <div>
              ...
              <p>
                ...
                <span>ever</span> uploaded to the blockchain!
              </p>
            </div>
            <div>
              <h3>How does Nest.land deal with malicious or broken modules?</h3>
              <p>
                If a module is reported to us as malicious or broken, we flag it on our registry. All users
                will then be warned when importing or updating this module.
              </p>
              <p className={styles.prevents}>
                <a
            ...
            <div>
              ...
              <p>
                Taking down a module is impossible thanks to the Arweave Blockchain! A module uploaded through
                our CLI is permanently immutable.
              </p>
              <p className={styles.prevents}>
                <a
            ...
            <div>
              ...
              <p>
                Yes, we do! If you wish to ensure security and immutability of your standard modules, check
                out nest.land's std <Link href="/std">mirror</Link>.
              </p>
            </div>
          </div>
        </div>
