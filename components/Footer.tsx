  ...
  return (
    <footer className={styles.footer}>
      <div className={styles.menus}>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <a href="https://github.com/nestdotland/api" target="_blank" rel="noopener noreferrer">
                API
              </a>
            </li>
            <li>
              <a href="https://verto.exchange" target="_blank" rel="noopener noreferrer">
                Verto
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul>
            <li>
              <a href="https://github.com/nestdotland" target="_blank" rel="noopener noreferrer">
                GitHub
              </a>
            </li>
            <li>
              <a href="https://twitter.com/nestdotland" target="_blank" rel="noopener noreferrer">
                Twitter
              </a>
            </li>
            <li>
              <a href="https://discord.gg/hYUsX3H" target="_blank" rel="noopener noreferrer">
                Discord
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul>
            <li>
              <a
                href="https://github.com/nestdotland/nest.land/blob/master/LICENSE"
                target="_blank"
                rel="noopener noreferrer"
              >
                License
            ...
            <li>
              <Link href="/TODO">Terms of Usage</Link>
            </li>
          </ul>
        </div>
      </div>
      ...
      <p className={styles.copyright}>
        Copyright © 2020 Nest team. Licensed under the{' '}
