...
export default function Nav() {
  ...
  return (
    <CSSTransition in={shown} timeout={300} classNames="fade-transition">
      <div className={styles.nav + (shown ? ' scrolled' : '')}>
        ...
        <div className={styles.links}>
          ...
          <a href="https://docs.nest.land" target="_blank" rel="noopener noreferer">
            Documentation
          </a>
          <Link href="/register">
            <a className={buttonStyles.button}>Get started</a>
          </Link>
        </div>
      </div>
    </CSSTransition>
